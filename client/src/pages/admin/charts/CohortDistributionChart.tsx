...
export default function CohortDistributionChart({ data, onDrillDown }: Props) {
      ...
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={chartData} margin={{ left: 10, right: 30, top: 20, bottom: 5 }}>
          ...
          <Tooltip
            ...
            labelFormatter={(label: any) => `Progress: ${label}`}
          />
          <Bar dataKey="value" radius={BAR_RADIUS} cursor="pointer" onClick={(data: any) => onDrillDown?.({ filterType: 'cohort_bucket', filterValue: data.name })}>
