...
interface Props {
  ...
  note: string | null;
  api: AdminApi;
  onToggle: (stepId: number, newStatus: string | null) => void;
  readOnly?: boolean;
  isOptional?: boolean;
}

export default function StepToggle({ studentId, stepId, stepTitle, stepIcon, status, completedAt, note: savedNote, api, onToggle, readOnly = false, isOptional = false }: Props) {
  const [loading, setLoading] = useState(false);
  const [showModal, setShowModal] = useState<ModalAction | null>(null);
